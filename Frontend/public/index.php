    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form action="/dashboard.php" method="post">
            ...
            <div class="mb-6">
                ...
                <input type="password" id="password" name="password" required class="shadow-sm appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-200 mb-3 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600" placeholder="••••••••">
            </div>
        ...
        <div class="mt-4 text-center">
            ...
            <p class="text-sm mt-2 text-gray-500 dark:text-gray-400">
                ...
                <a href="/Stock-Manager/backend/formularios/registro.php" class="font-bold text-blue-500 hover:text-blue-700">Crear cuenta</a>
            </p>
        </div>
    </div>
</div>
